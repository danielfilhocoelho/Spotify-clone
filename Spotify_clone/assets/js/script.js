...
function showOptionsMenu(button){
    ...
    var scrollTop = $(window).scrollTop(); // How much from the top of the page you have scrolled -- distance measure (top of the window-->top of the document)
    var elementOffset = $(button).offset().top; // Distance of the element from the top
